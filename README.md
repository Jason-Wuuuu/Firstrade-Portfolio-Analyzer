...
3.  HTML reports: Generated by the notebook, these provide a comprehensive view of your portfolio analysis.
...
4. Use the `generate_html_report()` function in the notebook to create a detailed HTML report of your portfolio analysis.
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; max-width: 800px; margin: 0 auto;">
  <img src="./outputs/output1.png" style="width: 100%; height: auto;">
  <img src="./outputs/output4.png" style="width: 100%; height: auto;">
